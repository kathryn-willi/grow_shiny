...
jgi <-   readRDS('data/GROWdb_CONTUS.RDS') 
...
col.list.global <- c('#D53E4F',
              ...
              '#66C2A5',
              '#5E4FA1')
colors.global <- paste0("color:",col.list.global,";")
    ...
    leafletProxy("map_1") %>% 
      addCircleMarkers(
        ...
        popup = paste(filtered_data_1()$SampleName,
                      ...
                      "<br>",
                      "Availble Meta: ", filtered_data_1()$AvailableMeta
                      ),
        radius = 3.5,
        color = ~ pal(Country),
        fillOpacity = 1)
    ...
    tab1 <- leafletProxy("map") %>%
      ...
      addCircleMarkers(
        ...
        popup = paste(filtered_data()$SampleName,
                      "<br>",
                      "HUC-2: ", filtered_data()$HUC2,
                      "<br>",
                      "Availble Meta: ", filtered_data()$AvailableMeta),
        radius = 2,
        color = ~pal(HUC2),
        fillOpacity = 0.90)
